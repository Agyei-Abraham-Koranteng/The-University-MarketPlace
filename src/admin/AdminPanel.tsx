        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-white">
            ...
            <aside className="w-full lg:w-80 bg-zinc-950 text-zinc-400 p-10 flex flex-col justify-between sticky top-0 h-screen">
                <div>
                    ...
                    <nav className="space-y-2">
                        {[
                            ...
                            { id: 'vendors', icon: 'fa-store', label: 'Stores' },
                ...
                <div className="bg-zinc-900/50 p-6 rounded-[32px] border border-white/5">
                    ...
                    <p className="text-[10px] text-zinc-600 font-medium">Auto-purge process active. Next cycle in 12h 4m.</p>
                </div>
            </aside>
            ...
            <main className="flex-1 p-8 md:p-16 h-screen overflow-y-auto no-scrollbar">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                    <div>
                        ...
                        <h2 className="text-4xl font-black text-zinc-950 tracking-tighter capitalize">{adminTab} Center</h2>
                    </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                            {[
                                ...
                                <div key={i} className="bg-white p-8 rounded-[32px] border border-zinc-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            <div className="lg:col-span-8 bg-zinc-950 rounded-[32px] p-8 text-white relative overflow-hidden h-[400px] shadow-2xl">
                                <div className="flex justify-between items-center mb-12">
                                    <div>
                                        ...
                                        <p className="text-2xl font-black tracking-tight">Platform Traffic Monitor</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-3 gap-8 mt-8 border-t border-white/5 pt-8">
                                    ...
                                    <div>
                                        <p className="text-[9px] font-black text-zinc-600 uppercase mb-1">Active Stores</p>
                            ...
                            {/* Activity Log Feed */}
                            <div className="lg:col-span-4 bg-zinc-50 rounded-[32px] p-8 border border-zinc-100 flex flex-col h-[400px]">
                ...
                {adminTab === 'approvals' && (
                    <div className="animate-in fade-in slide-in-from-right-8 duration-700">
                        <div className="flex justify-between items-end mb-12">
                            <div>
                                <h4 className="text-[10px] font-black text-indigo-500 uppercase tracking-[0.4em] mb-2">Pending Approvals</h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                            {pendingApps.map(app => (
                                <div key={app.id} className="bg-white p-8 rounded-[32px] border border-zinc-100 shadow-sm hover:shadow-2xl transition-all group">
                            ...
                            {pendingApps.length === 0 && (
                                <div className="col-span-full py-32 text-center rounded-[40px] border-4 border-dashed border-zinc-100">
                ...
                {adminTab === 'users' && (
                    <div className="animate-in fade-in duration-700">
                        <div className="bg-white rounded-[40px] border border-zinc-100 shadow-sm overflow-hidden p-6">
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-zinc-50">
                                        <th className="px-8 py-6 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Entity Identity</th>
                                        <th className="px-8 py-6 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Account Status</th>
                    ...
                    <div className="animate-in fade-in duration-700">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {filteredProducts.map(p => (
                                <div key={p.id} className="bg-white p-6 rounded-[32px] border border-zinc-100 shadow-sm hover:shadow-xl transition-all group overflow-hidden">
                                    ...
                                    <div className="px-4 pb-4">
                                        <div className="flex justify-between items-start mb-6">
                                            <div>
                                                ...
                                                <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Price: ${p.price}</p>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-3 pt-6 border-t border-zinc-50">
                                            ...
                                            <span className="text-[9px] font-black text-zinc-400 uppercase tracking-widest">Inventory Active</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            <div className="lg:col-span-4 space-y-8">
                                <div className="bg-zinc-950 rounded-[40px] p-8 text-white relative overflow-hidden group">
                                    <h4 className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.4em] mb-8">Site Controls</h4>
                                    <div className="space-y-6">
                                        <div className="flex justify-between items-center group/toggle cursor-pointer" onClick={props.onToggleMaintenance}>
                                            <div>
                                                ...
                                                <p className="text-[10px] text-zinc-500 font-medium">Suspend site activity</p>
                                            </div>
                            ...
                            <div className="lg:col-span-8">
                                <div className="bg-white rounded-[40px] border border-zinc-100 shadow-sm p-10">
                                    <h4 className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] mb-12">System Records</h4>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                        {[
                                            { label: 'Platform Name', value: 'UniMall Community Hub', type: 'text' },
                                            { label: 'Admin Console', value: '/admin', type: 'text' },
                                            { label: 'Security Key', value: '**************************', type: 'password' },
