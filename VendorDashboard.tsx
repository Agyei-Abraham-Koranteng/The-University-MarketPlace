  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)] bg-zinc-50">
      <aside className="w-full lg:w-80 bg-zinc-950 text-zinc-400 p-8 flex flex-col gap-10">
        <div>
          <h4 className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.4em] mb-8 px-4">Operational Node</h4>
            ...
            {[
              ...
              <button
                ...
                className={`w-full flex items-center space-x-5 px-5 py-4 rounded-[24px] transition-all group ${
                  activeTab === tab.id ? 'bg-white/10 text-white border border-white/10 shadow-3xl shadow-white/5 backdrop-blur-md' : 'hover:text-white'
                }`}
              >
        ...
        <div className="mt-auto bg-white/5 p-8 rounded-[32px] border border-white/10">
          <p className="text-[9px] font-black text-zinc-500 uppercase tracking-widest mb-2">Node Efficiency</p>
      ...
      <main className="flex-1 p-6 md:p-14 overflow-y-auto no-scrollbar">
        {activeTab === 'monitor' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="flex justify-between items-end mb-14">
              <div>
                <h2 className="text-4xl font-black text-zinc-950 tracking-tighter">Node Monitor</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {[
                ...
                { label: 'Rating Node', value: vendor.rating.toFixed(1), icon: 'fa-star', color: 'emerald' }
              ].map((stat, i) => (
            ...
            <div className="bg-white rounded-[56px] border border-zinc-100 p-12 relative overflow-hidden">
        ...
        {activeTab === 'inventory' && (
          <div className="animate-in fade-in duration-700">
            <div className="flex justify-between items-end mb-14">
               <h2 className="text-4xl font-black text-zinc-950 tracking-tighter">Inventory Control</h2>
